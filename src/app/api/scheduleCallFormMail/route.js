// app/api/scheduleCallFormMail/route.js
  ...
  const mailOptions = {
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0 0 10px rgba(0, 0, 0, 0.1);">
        ...
        <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
            ...
            <tr>
                <td style="padding: 8px; background-color: #f1f1f1; font-weight: bold;">Mode of Meeting:</td>
                <td style="padding: 8px; color: #333333;">${modeMeeting}</td>
            </tr>
            
            <tr>
                <td style="padding: 8px; background-color: #f1f1f1; font-weight: bold;">Date:</td>
                <td style="padding: 8px; color: #333333;">${selectedDate}</td>
            </tr>
            
            <tr>
                <td style="padding: 8px; background-color: #f1f1f1; font-weight: bold;">Time:</td>
                <td style="padding: 8px; color: #333333;">${selectedTime}</td>
            </tr>
