...
<Layout>
        ...
        <section className="h-[80vh] flex items-center overflow-hidden relative text-center thankyou-page-content">
          <div className="container z-10 relative">
            ...
            <h1 className="heading-1" data-aos="fade-up">Thank You for Reaching Out! </h1>
                        <p  data-aos="fade-up" data-delay="500">We’ve received your details and will get in touch with you shortly!</p>
                        <Link
                title="Back to home"
...
export async function generateMetadata() {
  return generateMetadataFromLib('', true, 'thankyou');
}